...
namespace Enums {
	...
	//Game FX
	public enum fxClip {BUTTON_HOVER, BUTTON_PRESSED, GUI_PICK_BONUS, OPEN_DOOR, OPEN_JAIL, COUNTDOWN, LOSE, WIN, WATER_CUBE, PLACARD_COLLISION, PICK_FOOD, PICK_SUIT, UNLOCK_LEVER, PICK_CLOK_KEY,NO_FX};
